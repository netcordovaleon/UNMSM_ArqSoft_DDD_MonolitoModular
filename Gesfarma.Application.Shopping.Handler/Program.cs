...
namespace Gesfarma.Application.Shopping.Handler;
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        Console.Title = "Gesfarma.Application.Shopping.Handler";
    ...
    public static IHostBuilder CreateHostBuilder(string[] args) =>
        Host.CreateDefaultBuilder(args)
            ...
            {
                var endpointConfiguration = ConfigureEndpoint("Gesfarma.Handler");
